  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<div class="container text-center mt-5">
            ...
            <div class="text-center mt-5 embed-responsive embed-responsive-16by9">
					...
					<iframe scrolling="no" width="640" height="480"class="embed-responsive-item" src="http://172.20.10.6:5000/"></iframe>
					<br>
					<br>
					<br>
					<br>
...
<footer class="text-muted py-5">
  <div class="container">
    ...
    <p class="mb-1">Create by Emilien and Gwenael, IA2R student in Polytech Nancy</p>
